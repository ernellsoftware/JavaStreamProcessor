...
public class InputStreamReader {
     ...
     */
    private static final int DEFAULT_MAX_LINE_LENGTH = 16;

    /** memory buffer size */
    private static final int DEFAULT_BUFFER_SIZE = 8192;

    /** min/max-length of a line to process */
	...
	try {
		...
		for (; nextChar < nChars; nextChar++) {
			...
			if (nLineLength <= restricted_max_length && nLineLength >= restricted_min_length) {
    ...
    /**
     * @param restricted_min_length
     *            the restricted_min_length to set
     */
    public void setRestricted_min_length(int restricted_min_length) {
	this.restricted_min_length = restricted_min_length;
    }

    /**
     * @param restricted_max_length
     *            the restricted_max_length to set
     */
    public void setRestricted_max_length(int restricted_max_length) {
     ...
     *            the restricted_min_length to set
     */
    public void setRestricted_length(int restricted_min_length, int restricted_max_length) {
	this.restricted_min_length = restricted_min_length;
	this.restricted_max_length = restricted_max_length;
    }
