 ...
 */
public class FilterEndsWith extends BaseFilter {
    ...
    /** Constructor */
    public FilterEndsWith(String arg_pattern, int arg_length) {
	...
	if (patternPos >= 0 && patternPos == patternPosMax)
	    return true;
	// no match
	return false;
    }
